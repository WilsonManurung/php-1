...
echo "<p>" . $first_sentence . " , panjang string " , strlen($first_sentence). " , jumlah kata " , str_word_count($first_sentence);
$second_sentence = "I'm ready for the challenges"; // Panjang string: 28, jumlah kata: 5 
echo "<p>" . $second_sentence . " , panjang string " , strlen($second_sentence). " , jumlah kata " , str_word_count($second_sentence);
...
// Lanjutkan di bawah ini echo "Kata kedua: " ; echo "<br> Kata Ketiga: " ; echo "<h3> Soal No 3 </h3>"; /* SOAL NO 3 Mengubah karakter atau kata yang ada di dalam sebuah string. */
$string3 = "PHP is old but sexy!"; echo "String: \"$string3\"<br> ";
